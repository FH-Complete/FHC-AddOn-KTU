...
$stgobj->load($stg);
//Logo
$pdf->Image("../../../skin/images/logo.jpg","480","45","","45","jpg","");
...
$pdf->MultiCell(450,20,'Anwesenheitsliste '.$bezeichnung,0,'L',0);
...
if(strlen("Anwesenheitsliste ".$bezeichnung)>50)
$pdf->SetXY(30,75);
else
$pdf->SetXY(30,60);
...
$pdf->SetFont('Arial','',8);
$pdf->SetXY(30,$maxY);
$inhalt[]=array(' ','HoererIn/Name','Kennzeichen','Semester','','','','','',''); //Spaltenueberschriften
...
$pdf->SetFont('Arial','',8);
		...
		$pdf->MultiCell(130,$lineheight,'Hoerer/Name',1,'L',0);
		$maxX +=130;
		$pdf->SetXY($maxX,$maxY);
		$pdf->MultiCell(65,$lineheight,'Kennzeichen',1,'C',0);
		$maxX +=65;
		$pdf->SetXY($maxX,$maxY);
		$pdf->MultiCell(65,$lineheight,'Semester',1,'C',0);
		$maxX +=65;
		$pdf->SetXY($maxX,$maxY);
		$pdf->MultiCell(40,$lineheight,'',1,'L',0);
		$maxX +=40;
