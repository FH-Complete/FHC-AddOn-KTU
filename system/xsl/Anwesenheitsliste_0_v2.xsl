		...
		<office:document-content
			...
			<office:body>
				<office:text text:use-soft-page-breaks="true" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0">
					...
					<draw:frame draw:style-name="fr1" draw:name="Bild1" text:anchor-type="paragraph" svg:x="17.124cm" svg:y="1cm" svg:width="1.757cm" svg:height="2.242cm" draw:z-index="0">
						<draw:image xlink:href="Pictures/1000000000000178000001E0F10B39C560C1887C.png" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
					</draw:frame>
					...
					<table:table table:name="Tabelle1" table:style-name="Tabelle1">
						...
						<table:table-row table:style-name="Tabelle1.1">
							...
							<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
                                <text:p text:style-name="P11">Studium</text:p>
							</table:table-cell>
							<table:table-cell table:style-name="Tabelle1.A2" office:value-type="string">
								<text:p text:style-name="P6"/>
							</table:table-cell>
		...
		<xsl:choose>
			<xsl:when test="$number mod 2 != 0">
				<table:table-row table:style-name="Tabelle1.1">
					...
					<table:table-cell table:style-name="Tabelle1.A8" office:value-type="string">
                        <text:p text:style-name="P8"><xsl:value-of select="studiengang_kurzbz" /></text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle1.A8" office:value-type="string">
						<text:p text:style-name="P6"/>
					</table:table-cell>
