...
>
		...
		<office:document-content xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:fo="urn:oasis:names:tc:opendocument:xmlns:xsl-fo-compatible:1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:meta="urn:oasis:names:tc:opendocument:xmlns:meta:1.0" xmlns:number="urn:oasis:names:tc:opendocument:xmlns:datastyle:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0" xmlns:chart="urn:oasis:names:tc:opendocument:xmlns:chart:1.0" xmlns:dr3d="urn:oasis:names:tc:opendocument:xmlns:dr3d:1.0" xmlns:math="http://www.w3.org/1998/Math/MathML" xmlns:form="urn:oasis:names:tc:opendocument:xmlns:form:1.0" xmlns:script="urn:oasis:names:tc:opendocument:xmlns:script:1.0" xmlns:ooo="http://openoffice.org/2004/office" xmlns:ooow="http://openoffice.org/2004/writer" xmlns:oooc="http://openoffice.org/2004/calc" xmlns:dom="http://www.w3.org/2001/xml-events" xmlns:xforms="http://www.w3.org/2002/xforms" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:rpt="http://openoffice.org/2005/report" xmlns:of="urn:oasis:names:tc:opendocument:xmlns:of:1.2" xmlns:xhtml="http://www.w3.org/1999/xhtml" xmlns:grddl="http://www.w3.org/2003/g/data-view#" xmlns:officeooo="http://openoffice.org/2009/office" xmlns:tableooo="http://openoffice.org/2009/table" xmlns:drawooo="http://openoffice.org/2010/draw" xmlns:calcext="urn:org:documentfoundation:names:experimental:calc:xmlns:calcext:1.0" xmlns:loext="urn:org:documentfoundation:names:experimental:office:xmlns:loext:1.0" xmlns:field="urn:openoffice:names:experimental:ooo-ms-interop:xmlns:field:1.0" xmlns:formx="urn:openoffice:names:experimental:ooxml-odf-interop:xmlns:form:1.0" xmlns:css3t="http://www.w3.org/TR/css3-text/" office:version="1.2">
			...
			<office:automatic-styles>
				...
				<style:style style:name="gr1" style:family="graphic">
					<style:graphic-properties draw:textarea-vertical-align="middle" style:wrap="run-through" style:number-wrapped-paragraphs="no-limit" style:vertical-pos="middle" style:vertical-rel="line" style:horizontal-pos="from-left" style:horizontal-rel="paragraph"/>
				</style:style>
			</office:automatic-styles>
			<office:body>
	...
	<xsl:template match="honorarvertrag">
		<office:text>
			...
			<text:p text:style-name="P3">Honorierung eines Lehrauftrages</text:p>
			<text:p text:style-name="P2"/>
			<text:p text:style-name="P6">Kostenstelle: ____________</text:p>
			<text:p text:style-name="P4">Stammdaten</text:p>
			...
			<text:p text:style-name="P2"/>
			<text:p text:style-name="P8">Lehrveranstaltung im ##Studiensemester</text:p>
			<text:p text:style-name="P8"/>
			<text:p text:style-name="P8">Genehmigung des <text:span text:style-name="T1">Honorars</text:span> in der Sitzung der Studienkommission vom: ##datum</text:p>
			<text:p text:style-name="P9">Genehmigung de<text:span text:style-name="T1">r Fahrtkosten</text:span> in der Sitzung der Studienkommission vom: ##datum</text:p>
			<text:p text:style-name="P2"/>
			<text:p text:style-name="P4">(A) Berechnung Honorar</text:p>
				...
				<table:table-row>
					<table:table-cell table:style-name="Tabelle3.A1" office:value-type="string">
						<text:p text:style-name="P12">
							<text:span text:style-name="T2">Anzahl Aufwandspunkte (AP): </text:span>
							<xsl:value-of select="vertraege/lehrvertrag/aufwandspunkte" />
						</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle3.B1" office:value-type="string">
						<text:p text:style-name="P12">
							<text:span text:style-name="T2">Honorar je AP:</text:span> € <xsl:value-of select="format-number(vertraege/lehrvertrag/stundensatz,'###,###,##0.00')" />
						</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row>
					<table:table-cell table:style-name="Tabelle3.A2" office:value-type="string">
						<text:p text:style-name="P12">
							<text:span text:style-name="T2">Summe:</text:span> € <xsl:value-of select="format-number(vertraege/lehrvertrag_summe,'###,###,##0.00')" />
						</text:p>
					</table:table-cell>
			...
			<text:p text:style-name="P2"/>
			<text:p text:style-name="P4">(B) Berechnung Fahrtkosten</text:p>
			<table:table table:name="Tabelle4" table:style-name="Tabelle4">
				...
				<table:table-row>
					<table:table-cell table:style-name="Tabelle4.A1" office:value-type="string">
						<text:p text:style-name="P12">
							<text:span text:style-name="T2">Abfahrtsort:</text:span>
				...
				<table:table-row>
					<table:table-cell table:style-name="Tabelle4.A2" office:value-type="string">
						<text:p text:style-name="P12">
							<text:span text:style-name="T2">Anzahl der Fahrten:</text:span>
							<xsl:value-of select="vertraege/fahrtkosten/anzahl_fahrten" />
						</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle4.B2" office:value-type="string">
						<text:p text:style-name="P12">
							<text:span text:style-name="T2">Fahrtkosten je Fahrt:</text:span> € <xsl:value-of select="format-number(vertraege/fahrtkosten/preis_je_fahrt,'###,###,##0.00')" />
						</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row>
					<table:table-cell table:style-name="Tabelle4.A2" office:value-type="string">
						<text:p text:style-name="P12">
							<text:span text:style-name="T2">Summe:</text:span> € <xsl:value-of select="format-number(vertraege/fahrtkosten/summe,'###,###,##0.00')" />
						</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle4.B2" office:value-type="string">
						<text:p text:style-name="P12"/>
			...
			<text:p text:style-name="P2"/>
			<text:p text:style-name="P7">(C) Gesamtbetrag für Lehrauftrag (A) + (B): € <xsl:value-of select="format-number(vertraege/fahrtkosten/summe + vertraege/lehrvertrag_summe,'###,###,##0.00')" />
			</text:p>
			<text:p text:style-name="P2"/>
			<text:p text:style-name="P4">(D) Auszahlung</text:p>
			<table:table table:name="Tabelle5" table:style-name="Tabelle5">
				<table:table-column table:style-name="Tabelle5.A"/>
				<table:table-column table:style-name="Tabelle5.B"/>
				<table:table-row>
					<table:table-cell table:style-name="Tabelle5.A1" office:value-type="string">
						<text:p text:style-name="P11"><draw:control text:anchor-type="as-char" draw:z-index="1" draw:style-name="gr1" draw:text-style-name="P14" svg:width="0.318cm" svg:height="0.292cm" draw:control="control1"/> <text:span text:style-name="T2">Lohnverrechnung</text:span></text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle5.B1" office:value-type="string">
						<text:p text:style-name="P11">Gesamtbetrag (C): € <xsl:value-of select="format-number(vertraege/fahrtkosten/summe + vertraege/lehrvertrag_summe,'###,###,##0.00')" />
						</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row>
					<table:table-cell table:style-name="Tabelle5.A2" office:value-type="string">
						<text:p text:style-name="P11">monatl. Auszahlung Honorar: (Betrag / 6 Monate)</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle5.B2" office:value-type="string">

						<text:p text:style-name="P11">€ <xsl:value-of select="format-number(vertraege/lehrvertrag_summe div 6,'###,###,##0.00')" />
						</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row>
					<table:table-cell table:style-name="Tabelle5.A2" office:value-type="string">
						<text:p text:style-name="P11">monatl. Auszahlung Fahrtkosten: (Betrag / 6 Monate)</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle5.B2" office:value-type="string">
						<text:p text:style-name="P11">€ <xsl:value-of select="format-number(vertraege/fahrtkosten/summe div 6,'###,###,##0.00')" />
						</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row>
					<table:table-cell table:style-name="Tabelle5.A2" office:value-type="string">
						<text:p text:style-name="P11">von Monat: ___________ bis Monat: ___________</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle5.B2" office:value-type="string">
						<text:p text:style-name="P11"/>
					</table:table-cell>
				...
				<table:table-row>
					<table:table-cell table:style-name="Tabelle5.A2" office:value-type="string">
						<text:p text:style-name="P11">
							<draw:control text:anchor-type="as-char" draw:z-index="1" draw:style-name="gr1" draw:text-style-name="P14" svg:width="0.318cm" svg:height="0.292cm" draw:control="control2"/> <text:span text:style-name="T2">Einmalige Überweisung</text:span></text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle5.B2" office:value-type="string">
						<text:p text:style-name="P11">Gesamtbetrag (C): <xsl:value-of select="format-number(vertraege/fahrtkosten/summe + vertraege/lehrvertrag_summe,'###,###,##0.00')" />
						</text:p>
			...
			<table:table table:name="Tabelle6" table:style-name="Tabelle6">
				...
				<table:table-row>
					<table:table-cell table:style-name="Tabelle6.A1" office:value-type="string">
						<text:p text:style-name="P11">bearbeitet von: ##bearbeiter</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle6.B1" office:value-type="string">
						<text:p text:style-name="P11">Datum: ##datum</text:p>
					</table:table-cell>
				</table:table-row>
				<table:table-row>
					<table:table-cell table:style-name="Tabelle6.A2" office:value-type="string">
						<text:p text:style-name="P11">genehmigt von: ##genehmigtVon</text:p>
					</table:table-cell>
