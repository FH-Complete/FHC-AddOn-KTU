...
<xsl:template match="zertifikat">	
		<office:text text:use-soft-page-breaks="true">
			...
			<text:p text:style-name="P11">KATHOLOGISCH-THEOLOGISCHE <text:span text:style-name="T1">PRIVAT</text:span>UNIVERSITÄT LINZ</text:p>
			<text:p text:style-name="P11"><xsl:value-of select="oe/oe_typ"/><xsl:text> </xsl:text><xsl:value-of select="oe/oe_bezeichnung"/></text:p>
			...
			<table:table table:name="Tabelle2" table:style-name="Tabelle2">
				...
				<table:table-row>
					<table:table-cell table:style-name="Tabelle2.A4" table:number-columns-spanned="5" office:value-type="string">
						...
						<text:p text:style-name="P7"><xsl:value-of select="bezeichnung"/></text:p>
					</table:table-cell>
					<table:covered-table-cell/>
					<table:covered-table-cell/>
					<table:covered-table-cell/>
			...
			<table:table table:name="Tabelle3" table:style-name="Tabelle3">
				...
				<table:table-row>
					...
					<table:table-cell table:style-name="Tabelle3.A1" office:value-type="string">
						...
						<text:p text:style-name="Standard"><xsl:value-of select="pruefer"/></text:p>
					</table:table-cell>
