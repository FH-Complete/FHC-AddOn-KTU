		...
		<office:text text:use-soft-page-breaks="true">
			...
			<text:p text:style-name="P10">
				<draw:frame draw:style-name="fr1" draw:name="Grafik1" text:anchor-type="paragraph" svg:width="17cm" svg:height="2.877cm" draw:z-index="0">
					<draw:image xlink:href="Pictures/100000000000140F0000036594D9B23D.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
				</draw:frame>
			</text:p>
			...
			<table:table table:name="Tabelle1" table:style-name="Tabelle1">
				...
				<table:table-row>
					...
					<table:table-cell table:style-name="Tabelle1.B1" office:value-type="string">
                        ...
                        <text:p text:style-name="P3">Matrikelnummer</text:p>
				...
				<table:table-row>
					<table:table-cell table:style-name="Tabelle1.A2" table:number-columns-spanned="2" office:value-type="string">
						...
						<text:p text:style-name="P8">
							<text:span text:style-name="T2"><xsl:value-of select="stg_studiengang_bezeichnung"/></text:span>
				...
				<table:table-row>
					...
					<table:table-cell table:style-name="Tabelle2.A1" office:value-type="string">
						<text:p text:style-name="P3">CP <text:note text:id="ftn2" text:note-class="footnote">
								...
								<text:note-body>
									<text:p text:style-name="P12">Studienleistungen werden in Creditpoints (CP) nach ECTS bemessen. 1 CP steht für einen Arbeitsaufwand von 25 Stunden zur Erreichung des Bildungsziels der Lehrveranstaltung.</text:p>
									<text:p text:style-name="P2"/>
								</text:note-body>
							</text:note>
						</text:p>
					...
					<table:table-cell table:style-name="Tabelle2.E1" office:value-type="string">
						...
						<text:p text:style-name="P6">
							<xsl:if test="contains(studiensemester, 'SS')">
								SoSe<xsl:value-of select="substring-after(studiensemester, 'SS')"/>
							</xsl:if>
							<xsl:if test="contains(studiensemester, 'WS')">
								WiSe<xsl:value-of select="substring-after(studiensemester, 'WS')"/>
							</xsl:if>
						</text:p>
					</table:table-cell>
				</table:table-row>
