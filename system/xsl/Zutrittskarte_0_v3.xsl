...
<xsl:stylesheet version="1.0"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="mitarbeiter">
        ...
        <text:p text:style-name="P1">
            <draw:frame draw:style-name="fr1" draw:name="Grafik_{$uid}" text:anchor-type="char" svg:x="0.5cm" svg:y="1.7cm" svg:width="1.95cm" svg:height="2.6cm" draw:z-index="{$idx}5">
                <draw:image xlink:href="Pictures/{$uid}.jpg" xlink:type="simple" xlink:show="embed" xlink:actuate="onLoad"/>
            </draw:frame>
            <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}0" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5cm" svg:height="0.3cm" svg:x="2.94cm" svg:y="1.85cm">
                <draw:text-box>
            ...
            <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}1" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5cm" svg:height="0.3cm" svg:x="2.94cm" svg:y="2.2cm">
                <draw:text-box>
                    <text:p text:style-name="P7">
            ...
            <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}2" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5cm" svg:height="0.3cm" svg:x="2.94cm" svg:y="2.55cm">
                <draw:text-box>
                    <text:p text:style-name="P7">
            ...
            <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}3" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5cm" svg:height="0.3cm" svg:x="2.94cm" svg:y="2.9cm">
                <draw:text-box>
                    <text:p text:style-name="P7">
                        <text:span text:style-name="T1"><xsl:value-of select="organisationseinheit"/></text:span>
                    </text:p>
                </draw:text-box>
            </draw:frame>
            <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}4" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5cm" svg:height="0.3cm" svg:x="2.94cm" svg:y="3.6cm">
                <draw:text-box>
                    <text:p text:style-name="P7">
            ...
            <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}5" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5cm" svg:height="0.3cm" svg:x="2.94cm" svg:y="3.95cm">
                <draw:text-box>
                    <text:p text:style-name="P7">
                        <text:span text:style-name="T1"><xsl:value-of select="uid"/></text:span>
                    </text:p>
                </draw:text-box>
            </draw:frame>
        </text:p>
    ...
    <xsl:template match="student">
        ...
        <text:p text:style-name="P1">
            ...
            <draw:frame text:anchor-type="paragraph" draw:z-index="{$idx}4" draw:style-name="gr1" draw:text-style-name="P7" svg:width="5.79cm" svg:height="0.3cm" svg:x="2.7cm" svg:y="3.85cm">
                <draw:text-box>
                    <text:p text:style-name="P7">
                        <text:span text:style-name="T1"><xsl:value-of select="matr_nr"/></text:span>
                    </text:p>
                </draw:text-box>
            </draw:frame>
        </text:p>
