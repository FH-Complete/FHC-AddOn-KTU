		...
		<fo:page-sequence master-reference="PageMaster">
			<fo:flow  ><!--flow-name="xsl-region-body"-->
				...
				<fo:block-container position="absolute" top="90mm" left="15mm">
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Zum Ändern des Passworts, öffnen Sie bitte die Seite: https://cis.ktu-linz.ac.at/cis/private/profile/change_password.php 
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Bei Fragen oder Problemen stehe ich Ihnen gerne unter sinn@ktu-linz.ac.at oder telefonisch unter +43 / (0)732 / 78 42 93 - 4135 zur Verfügung.\n\n
					</fo:block>
