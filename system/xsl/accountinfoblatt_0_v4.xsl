			...
			<fo:flow  ><!--flow-name="xsl-region-body"-->
				...
				<fo:block-container position="absolute" top="90mm" left="15mm">
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Zum Aktivieren Ihres Zugangs öffnen Sie mit Ihrem Web-Browser die Adresse https://cis.ku-linz.at/cis/public/accountactivation.php\n
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Zum Ändern des Passworts, öffnen Sie bitte die Seite: https://cis.ku-linz.at/cis/private/profile/change_password.php 
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Ihre Mails können Sie unter http://email.ku-linz.at abrufen. Melden Sie sich bitte auf dieser Seite mit der E-Mailadresse und dem von Ihnen gewählten Passwort an.\n\n
					</fo:block>
					...
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Bei Fragen oder Problemen steht das Team der Studierendenverwaltung gerne unter sinn@ku-linz.at oder telefonisch unter +43 / (0)732 / 78 42 93 - 4135 zur Verfügung.\n\n
					</fo:block>
					
					<fo:block text-align="left" font-family="sans-serif" font-size="10pt">
						Studierendenverwaltung der KU-Linz
					</fo:block>
				</fo:block-container>
