  ...
  <office:body>
    <office:text>
      ...
      <text:p text:style-name="P3"/>
			<text:p text:style-name="P3"/>
      <text:p text:style-name="P2">Account Mini FAQ</text:p>
      <text:p text:style-name="P2"/>
      ...
      <text:p text:style-name="P4">Ihre Mails können Sie unter https://login.microsoftonline.com abrufen. Melden Sie sich bitte auf dieser Seite mit der E-Mailadresse und dem von Ihnen gewählten Passwort an.</text:p>
      <text:p text:style-name="P4"/>
      <text:p text:style-name="P3">Wo erhalte ich weitere Informationen?</text:p>
      <text:p text:style-name="P4">Bei Fragen oder Problemen steht das Team der Studierendenverwaltung gerne unter sinn@ku-linz.at oder telefonisch unter +43 / (0)732 / 78 42 93 - 4135 zur Verfügung. Weitere Kontaktdaten finden Sie hier: https://ku-linz.at/studium/service/studienberatung/</text:p>
			<text:p text:style-name="P2">________________________________________________________________________</text:p>
			<text:p text:style-name="P2"/>
      <text:p text:style-name="P3">How to activate my account?</text:p>
      <text:p text:style-name="P4">Please go to https://cis.ku-linz.at/cis/public/accountactivation.php (switch to English language at the top right drop-down menu) and log-in with your username (Benutzername) and code (Aktivierungscode). Create a password of your choice (follow the guidelines as given at the website).</text:p>
      <text:p text:style-name="P4"/>
      <text:p text:style-name="P3">How to change my password (possible only, if the account is activated already)?</text:p>
      <text:p text:style-name="P4">Please go to https://cis.ku-linz.at/cis/private/profile/change_password.php</text:p>
      <text:p text:style-name="P5">Login with your username and password (and follow the instruction as given at the website).</text:p>
      <text:p text:style-name="P4"/>
      <text:p text:style-name="P3">How to access my webmail?</text:p>
      <text:p text:style-name="P4">You will find access at https://login.microsoftonline.com</text:p>
			<text:p text:style-name="P4">Please login with your e-mail address and your password as usual.</text:p>
      <text:p text:style-name="P4"/>
      <text:p text:style-name="P3">Where to get further Information?</text:p>
      <text:p text:style-name="P4">In case of questions or demand for support please write to sinn@ku-linz.ac.at or call +43 / (0)732 / 78 42 93 – 4135. Further contact details are available here:</text:p>
			<text:p text:style-name="P4">https://ku-linz.at/studium/service/studienberatung/</text:p>
    </office:text>
  </office:body>
