...
<xsl:template name="abschnitt">
	<text:p text:style-name="P9">Studienbestätigung Katholische Privat-Universität Linz</text:p>
		<table:table table:name="Tabelle1" table:style-name="Tabelle1">
			...
			<table:table-row table:style-name="Tabelle1.1">
				...
				<table:table-cell table:style-name="Tabelle1.B1" office:value-type="string">
					<text:p text:style-name="P6">Matrikelnummer</text:p>
			...
			<table:table-row table:style-name="Tabelle1.2">
				...
				<table:table-cell table:style-name="Tabelle1.B2" office:value-type="string">
                    <text:p text:style-name="P6">SV-Nummer</text:p>
					<text:p text:style-name="P7">
		...
		<text:p text:style-name="P1">
			...
			ist im<xsl:text> </xsl:text><xsl:value-of select="studiensemester_aktuell_bezeichnung" /><xsl:text> </xsl:text>
			als
			<xsl:choose>
			...
			<text:line-break />der Studienrichtung <xsl:text> </xsl:text>
			<xsl:choose>
		...
		<table:table table:name="Tabelle2" table:style-name="Tabelle2">
			...
			<table:table-row>
				<table:table-cell table:style-name="Tabelle2.A1" office:value-type="string">
					<text:p text:style-name="P2">Datum:<xsl:text> </xsl:text><xsl:value-of select="tagesdatum" /><xsl:text> </xsl:text>DVR: 0029874(1739)</text:p>
				</table:table-cell>
				<table:table-cell table:style-name="Tabelle2.A1" office:value-type="string">
