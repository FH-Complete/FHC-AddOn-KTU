			...
			<table:table table:name="Tabelle5" table:style-name="Tabelle5">
				...
				<table:table-row table:style-name="Tabelle5.1">
					<table:table-cell table:style-name="Tabelle5.A1" office:value-type="string">
						...
						<text:p text:style-name="P10">für das <xsl:value-of select="studiensemester_aktuell" />
						</text:p>
					</table:table-cell>
					...
					<table:table-cell table:style-name="Tabelle5.B2" office:value-type="string">
						...
						<table:table table:name="Tabelle2" table:style-name="Tabelle2">
							...
							<table:table-row>
								...
								<table:table-cell table:style-name="Tabelle2.A1" office:value-type="string">
									<text:p text:style-name="P19">
										<xsl:value-of select="datum_reifepruefung" />
									</text:p>
								</table:table-cell>
							</table:table-row>
							<table:table-row>
								...
								<table:table-cell table:style-name="Tabelle2.A1" office:value-type="string">
									<text:p text:style-name="P19">
										<xsl:value-of select="schulform_zgv" />
									</text:p>
								</table:table-cell>
							</table:table-row>
							<table:table-row>
			...
			<table:table table:name="Tabelle1" table:style-name="Tabelle1">
				...
				<table:table-row>
					...
					<table:table-cell table:style-name="Tabelle1.B2" office:value-type="string">
						<text:p text:style-name="P14">
							<xsl:value-of select="studienplan_bezeichnung" />
						</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle1.C2" office:value-type="string">
						<text:p text:style-name="P14">
							<xsl:value-of select="ausbildungssemester_aktuell" />
						</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle1.D2" office:value-type="string">
						<text:p text:style-name="P14">
							<xsl:value-of select="studiensemester_beginndatum"/>
						</text:p>
					</table:table-cell>
					...
					<table:table-cell table:style-name="Tabelle4.A1" office:value-type="string">
						...
						<text:p text:style-name="P2">
							...
							<text:span text:style-name="T2">
								<xsl:value-of select="datum_aktuell"/>
							</text:span>
						</text:p>
					</table:table-cell>
					<table:table-cell table:style-name="Tabelle4.A1" office:value-type="string">
