			...
			<table:table table:name="Tabelle5" table:style-name="Tabelle5">
				...
				<table:table-row table:style-name="Tabelle5.1">
					<table:table-cell table:style-name="Tabelle5.A1" office:value-type="string">
						<text:p text:style-name="P8">Studienblatt</text:p>
						<text:p text:style-name="P6"/>
						<text:p text:style-name="P7">
							<xsl:if test="substring(anmerkungpre,1,3)='aoH'">
								des/der außerordentlichen Studierenden
							</xsl:if>
							<xsl:if test="substring(anmerkungpre,1,3)!='aoH'">
								des/der ordentlichen Studierenden
							</xsl:if>
						</text:p>
					...
					<table:table-cell table:style-name="Tabelle5.B1" office:value-type="string">
						<table:table table:name="Tabelle3" table:style-name="Tabelle3">
							...
							<table:table-row>
								<table:table-cell table:style-name="Tabelle3.A1" office:value-type="string">
									<text:p text:style-name="P16">Matrikelnummer:</text:p>
								</table:table-cell>
								<table:table-cell table:style-name="Tabelle3.A1" office:value-type="string">
			...
			<table:table table:name="Tabelle1" table:style-name="Tabelle1">
				...
				<table:table-row>
					...
					<table:table-cell table:style-name="Tabelle1.D2" office:value-type="string">
						<xsl:choose>
							<xsl:when test="contains(studiensemester_beginn,'Wintersemester')">
								<text:p text:style-name="P10">01.10.<xsl:value-of select="substring(studiensemester_beginndatum, 7, 4)"/></text:p>
							</xsl:when>
							<xsl:otherwise>
								<text:p text:style-name="P10">01.03.<xsl:value-of select="substring(studiensemester_beginndatum, 7, 4)"/></text:p>
							</xsl:otherwise>
						</xsl:choose>
					</table:table-cell>
