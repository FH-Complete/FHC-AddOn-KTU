			...
			<fo:page-sequence master-reference="PageMaster">
				<fo:flow flow-name="xsl-region-body" >
					...
					<fo:block-container position="absolute" top="20mm" left="15mm">
						<fo:block font-size="16pt">Katholische Privat-Universität Linz</fo:block>
					</fo:block-container>
						...
						<fo:table-column column-width="155mm"/>
							<fo:table-body>
								<fo:table-row>
									...
									<fo:table-cell>
									<fo:block font-size="7pt">Sehr gut (1), Gut (2), Befriedigend (3), Genügend (4), Nicht genügend (5), angerechnet (ar), mit Erfolg teilgenommen (met), absolviert(abs)</fo:block>
									</fo:table-cell>
								</fo:table-row>
								<fo:table-row>
									<fo:table-cell>
