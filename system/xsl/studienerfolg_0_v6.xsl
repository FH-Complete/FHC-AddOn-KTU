...
<xsl:template match="studienerfolg">
		<office:text text:use-soft-page-breaks="true" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:draw="urn:oasis:names:tc:opendocument:xmlns:drawing:1.0" xmlns:svg="urn:oasis:names:tc:opendocument:xmlns:svg-compatible:1.0">
			...
			<table:table table:name="Tabelle1" table:style-name="Tabelle1">
				...
				<table:table-row table:style-name="Tabelle1.1">
					...
					<table:table-cell table:style-name="Tabelle1.B1" office:value-type="string">
						...
						<text:p text:style-name="P7"><xsl:value-of select="matr_nr" /></text:p>
					</table:table-cell>
				</table:table-row>
					...
					<table:table-cell table:style-name="Tabelle1.A1" office:value-type="string">
						...
						<text:p text:style-name="P13">
							<text:span text:style-name="T4">
								<xsl:if test="contains(studiensemester_aktuell, 'SS')">
									SoSe<xsl:value-of select="substring-after(studiensemester_aktuell, 'SS')"/>
								</xsl:if>
								<xsl:if test="contains(studiensemester_aktuell, 'WS')">
									WiSe<xsl:value-of select="substring-after(studiensemester_aktuell, 'WS')"/>
								</xsl:if>
							</text:span>
						</text:p>
					</table:table-cell>
			...
			<text:p text:style-name="P6"/>
			<text:p text:style-name="P18">Folgende Prüfungen wurden erfolgreich abgelegt:</text:p>
			...
			<text:p text:style-name="P20">Benotung:
				<text:span text:style-name="T9">Sehr gut (1), Gut (2), Befriedigend (3), Genügend (4), Nicht genügend (5), angerechnet (ar), mit Erfolg teilgenommen (met), absolviert (abs)</text:span>
			</text:p>
		</office:text>
</xsl:template>
